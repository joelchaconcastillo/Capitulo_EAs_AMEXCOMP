...
\cortext[cor1]{Autor de contacto.}
...
tienen sobre la diversidad mantenida en la población y con base en ello rediseñarlos para modificar su comportamiento de forma dinámica.
%
...
%
El segundo caso está enfocado a los operadores de cruza, donde concretamente se analiza y extiende el Operador de Cruza basado en Simulación 
...
\section{Diseño de operadores de cruza basados en diversidad}
...
\label{sec:Para_saber_mas}
\input{Para_saber_mas.tex}
...
\bibliography{AMEXCOMP-Segura-18}
